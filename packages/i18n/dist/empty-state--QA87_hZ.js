//#region src/locales/zh-CN/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "选择一个接收工作项以查看其详细信息" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "为您的工作保留重要的参考、资源或文档" },
		inbox_sidebar_all: { title: "您订阅的工作项的更新将显示在此处" },
		inbox_sidebar_mentions: { title: "您的工作项的提及将显示在此处" },
		your_work_by_priority: { title: "尚未分配工作项" },
		your_work_by_state: { title: "尚未分配工作项" },
		views: {
			title: "暂无视图",
		...
		analytics_projects: { title: "创建项目以在此处可视化项目指标。" },
		analytics_work_items: { title: "创建包含工作项和受理人的项目,以开始在此处跟踪绩效、进度和团队影响。" },
		analytics_no_cycle: { title: "创建周期以将工作组织成有时限的阶段并跟踪冲刺进度。" },
		analytics_no_module: { title: "创建模块以组织工作并跟踪不同阶段的进度。" },
		analytics_no_intake: { title: "设置接收以管理传入请求并跟踪它们的接受和拒绝情况" }
	},
...
//# sourceMappingURL=empty-state--QA87_hZ.js.map