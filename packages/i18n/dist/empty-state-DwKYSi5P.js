//#region src/locales/es/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "Selecciona un elemento de trabajo de Entrada para ver sus detalles" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "Mantén a mano referencias importantes, recursos o documentos para tu trabajo" },
		inbox_sidebar_all: { title: "Las actualizaciones de tus elementos de trabajo suscritos aparecerán aquí" },
		inbox_sidebar_mentions: { title: "Las menciones a tus elementos de trabajo aparecerán aquí" },
		your_work_by_priority: { title: "Aún no hay elementos de trabajo asignados" },
		your_work_by_state: { title: "Aún no hay elementos de trabajo asignados" },
		views: {
		...
		analytics_projects: { title: "Crea proyectos para visualizar las métricas del proyecto aquí." },
		analytics_work_items: { title: "Crea proyectos con elementos de trabajo y responsables para comenzar a rastrear el rendimiento, progreso e impacto del equipo aquí." },
		analytics_no_cycle: { title: "Crea ciclos para organizar el trabajo en fases con límite de tiempo y rastrear el progreso en los sprints." },
		analytics_no_module: { title: "Crea módulos para organizar tu trabajo y rastrear el progreso en diferentes etapas." },
		analytics_no_intake: { title: "Configura la entrada para gestionar las solicitudes entrantes y rastrear cómo se aceptan y rechazan" }
	},
...
//# sourceMappingURL=empty-state-DwKYSi5P.js.map