//#region src/locales/en/translations.ts
var translations_default = {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Manage widgets" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "New at Plane" },
		quick_tutorial: { title: "Quick tutorial" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Error fetching {entity}" },
		add: {
	...
	epic: {
		...
		new: "New Epic",
		adding: "Adding epic",
		create: { success: "Epic created successfully" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Remove parent work item" }
		},
		new: "New Work item",
		adding: "Adding work item",
		create: { success: "Work item created successfully" },
		priority: {
			urgent: "Urgent",
			high: "High",
			medium: "Medium",
		...
		comments: {
			...
			upload: { error: "Asset upload failed. Please try again later." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "View other work items" }
		} },
		sibling: { label: "Sibling work items" },
		archive: {
			...
			failed: { message: "Work item could not be archived. Please try again." }
		},
		restore: {
			success: {
			...
			failed: { message: "Work item could not be restored. Please try again." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Create View" },
		update: { label: "Update View" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Create intake work item" },
		tabs: {
			open: "Open",
			closed: "Closed"
		},
		empty_state: {
			...
			detail: { title: "Select a work item to view its details." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# month} other{# months}}" },
		empty_state: {
			general: {
			...
			search: { description: "No projects detected with the matching criteria.\nCreate a new project instead" }
		}
	},
	workspace_views: {
		add_view: "Add view",
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Create new work item" }
			},
			assigned: {
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Secret key copied to clipboard." },
					secret_key_not_copied: { message: "Error occurred while copying secret key." }
				}
			},
			api_tokens: {
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "Error while updating the label" }
		},
		estimates: {
			heading: "Estimates",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Upcoming cycle" },
		completed_cycle: { label: "Completed cycle" },
		status: {
			days_left: "Days left",
			completed: "Completed",
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "You already have a cycle on the given dates, if you want to create a draft cycle, you can do that by removing both the dates." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Create new work item" },
				secondary_button: { text: "Add existing work item" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Set automation" }
		},
		issues_empty_filter: {
			title: "No work items found matching the filters applied",
			secondary_button: { text: "Clear all filters" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Create new work items" },
				secondary_button: { text: "Add an existing work item" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Module link copied to clipboard" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Create your first page" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "No results found" } } },
	issue_relation: { empty_state: {
		search: { title: "No matching work items found" },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Select to view details." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "Add work items to the cycle to view it's progress" },
		chart: { title: "Add work items to the cycle to view the burndown chart." },
		priority_issue: { title: "Observe high priority work items tackled in the cycle at a glance." },
		assignee: { title: "Add assignees to work items to see a breakdown of work by assignees." },
		label: { title: "Add labels to work items to see the breakdown of work by labels." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Manage features" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Create your first draft" }
		},
		delete_modal: {
			title: "Delete draft",
	...
	stickies: {
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Add sticky" }
			},
			search: {
	...
	role_details: {
		...
		admin: {
			title: "Admin",
			description: "All permissions set to\xA0true\xA0within the workspace."
		}
	},
	user_roles: {
	...
	themes: { theme_options: {
		system_preference: { label: "System preference" },
		light: { label: "Light" },
		dark: { label: "Dark" },
		light_contrast: { label: "Light high contrast" },
		dark_contrast: { label: "Dark high contrast" },
		custom: { label: "Custom theme" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
	...
	power_k: {
		...
		footer: { workspace_level: "Workspace level" },
		group_titles: {
...
//#endregion
export { translations_default as t };
//# sourceMappingURL=translations-l3KgGcEA.js.map