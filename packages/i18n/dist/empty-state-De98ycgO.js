//#region src/locales/en/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "Select an Intake work item to view its details" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "Keep important references, resources, or docs handy for your work" },
		inbox_sidebar_all: { title: "Updates for your subscribed work items will appear here" },
		inbox_sidebar_mentions: { title: "Mentions for your work items will appear here" },
		your_work_by_priority: { title: "No work item assigned yet" },
		your_work_by_state: { title: "No work item assigned yet" },
		views: {
			title: "No Views yet",
		...
		analytics_projects: { title: "Create projects to visualize project metrics here." },
		analytics_work_items: { title: "Create projects with work items and assignees to start tracking performance, progress, and team impact here." },
		analytics_no_cycle: { title: "Create cycles to organise work into time-bound phases and track progress across sprints." },
		analytics_no_module: { title: "Create modules to organize your work and track progress across different stages." },
		analytics_no_intake: { title: "Set up intake to manage incoming requests and track how they're accepted and rejected" }
	},
...
//#endregion
export { empty_state_default as t };
//# sourceMappingURL=empty-state-De98ycgO.js.map