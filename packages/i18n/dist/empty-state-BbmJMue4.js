//#region src/locales/ko/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "접수 작업 항목을 선택하여 세부 정보 보기" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "작업에 편리한 중요한 참조 자료, 리소스 또는 문서 보관" },
		inbox_sidebar_all: { title: "구독한 작업 항목에 대한 업데이트가 여기에 표시됩니다" },
		inbox_sidebar_mentions: { title: "작업 항목에 대한 언급이 여기에 표시됩니다" },
		your_work_by_priority: { title: "아직 할당된 작업 항목이 없습니다" },
		your_work_by_state: { title: "아직 할당된 작업 항목이 없습니다" },
		views: {
			title: "아직 보기가 없습니다",
		...
		analytics_projects: { title: "여기에서 프로젝트 지표를 시각화하려면 프로젝트를 생성하세요." },
		analytics_work_items: { title: "작업 항목 및 담당자가 있는 프로젝트를 생성하여 여기에서 성과, 진행 상황 및 팀 영향을 추적하기 시작하세요." },
		analytics_no_cycle: { title: "사이클을 생성하여 작업을 시간 제한 단계로 구성하고 스프린트 전반에 걸쳐 진행 상황을 추적하세요." },
		analytics_no_module: { title: "모듈을 생성하여 작업을 구성하고 다양한 단계에서 진행 상황을 추적하세요." },
		analytics_no_intake: { title: "접수를 설정하여 들어오는 요청을 관리하고 승인 및 거부 방법을 추적하세요" }
	},
...
//# sourceMappingURL=empty-state-BbmJMue4.js.map