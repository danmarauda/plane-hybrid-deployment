//#region src/locales/id/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "Pilih item kerja Masuk untuk melihat detailnya" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "Simpan referensi penting, sumber daya, atau dokumen untuk pekerjaan Anda" },
		inbox_sidebar_all: { title: "Pembaruan untuk item kerja yang Anda langgani akan muncul di sini" },
		inbox_sidebar_mentions: { title: "Penyebutan untuk item kerja Anda akan muncul di sini" },
		your_work_by_priority: { title: "Belum ada item kerja yang ditugaskan" },
		your_work_by_state: { title: "Belum ada item kerja yang ditugaskan" },
		views: {
		...
		analytics_projects: { title: "Buat proyek untuk memvisualisasikan metrik proyek di sini." },
		analytics_work_items: { title: "Buat proyek dengan item kerja dan penerima tugas untuk mulai melacak kinerja, kemajuan, dan dampak tim di sini." },
		analytics_no_cycle: { title: "Buat siklus untuk mengorganisir pekerjaan ke dalam fase berbatas waktu dan melacak kemajuan di seluruh sprint." },
		analytics_no_module: { title: "Buat modul untuk mengorganisir pekerjaan Anda dan melacak kemajuan di berbagai tahap." },
		analytics_no_intake: { title: "Siapkan masukan untuk mengelola permintaan masuk dan melacak bagaimana mereka diterima dan ditolak" }
	},
...
//# sourceMappingURL=empty-state-2HXwXn3J.js.map