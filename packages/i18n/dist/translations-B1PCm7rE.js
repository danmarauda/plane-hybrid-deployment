//#region src/locales/es/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Contraseña actual" },
				new_password: {
		...
		sign_up: {
			...
			errors: { password: { strength: "Intenta establecer una contraseña fuerte para continuar" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Vemos que tu administrador no ha habilitado SMTP, no podremos enviar un enlace para restablecer la contraseña" },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Gestionar widgets" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Nuevo en Plane" },
	...
	entity: {
		...
		fetch: { failed: "Error al obtener {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epic creado correctamente" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Eliminar elemento de trabajo padre" }
		},
		new: "Nuevo elemento de trabajo",
		adding: "Agregando elemento de trabajo",
		create: { success: "Elemento de trabajo creado correctamente" },
		priority: {
			urgent: "Urgente",
			high: "Alta",
			medium: "Media",
		...
		comments: {
			...
			upload: { error: "Error al subir el archivo. Por favor, inténtalo más tarde." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Ver otros elementos de trabajo" }
		} },
		sibling: { label: "Elementos de trabajo hermanos" },
		archive: {
			...
			failed: { message: "No se pudo archivar el elemento de trabajo. Por favor, inténtalo de nuevo." }
		},
		restore: {
			success: {
	...
	view: {
		...
		create: { label: "Crear vista" },
		update: { label: "Actualizar vista" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Crear elemento de trabajo de intake" },
		tabs: {
			open: "Abiertos",
			closed: "Cerrados"
		},
		empty_state: {
			...
			detail: { title: "Selecciona un elemento de trabajo para ver sus detalles." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# mes} other{# meses}}" },
		empty_state: {
			general: {
			...
			search: { description: "No se detectaron proyectos con los criterios coincidentes.\nCrea un nuevo proyecto en su lugar" }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Crear nuevo elemento de trabajo" }
			},
			assigned: {
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Clave secreta copiada al portapapeles." },
					secret_key_not_copied: { message: "Ocurrió un error al copiar la clave secreta." }
				}
			},
			api_tokens: {
				title: "Tokens de API",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Ciclo próximo" },
		completed_cycle: { label: "Ciclo completado" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Ya tienes un ciclo en las fechas dadas, si quieres crear un ciclo en borrador, puedes hacerlo eliminando ambas fechas." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Crear nuevo elemento de trabajo" },
				secondary_button: { text: "Agregar elemento de trabajo existente" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Establecer automatización" }
		},
		issues_empty_filter: {
			title: "No se encontraron elementos de trabajo que coincidan con los filtros aplicados",
			secondary_button: { text: "Limpiar todos los filtros" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Crear nuevos elementos de trabajo" },
				secondary_button: { text: "Agregar un elemento de trabajo existente" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Enlace del módulo copiado al portapapeles" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Crea tu primera página" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "No se encontraron resultados" } } },
	issue_relation: { empty_state: {
		search: { title: "No se encontraron elementos de trabajo coincidentes" },
		no_issues: { title: "No se encontraron elementos de trabajo" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Selecciona para ver detalles." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "Agrega elementos de trabajo al ciclo para ver su progreso" },
		chart: { title: "Agrega elementos de trabajo al ciclo para ver el gráfico de avance." },
		priority_issue: { title: "Observa los elementos de trabajo de alta prioridad abordados en el ciclo de un vistazo." },
		assignee: { title: "Agrega asignados a los elementos de trabajo para ver un desglose del trabajo por asignados." },
		label: { title: "Agrega etiquetas a los elementos de trabajo para ver el desglose del trabajo por etiquetas." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Gestionar funciones" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Crea tu primer borrador" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Borrador eliminado" }
		}
	},
	stickies: {
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Agregar nota adhesiva" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Preferencia del sistema" },
		light: { label: "Claro" },
		dark: { label: "Oscuro" },
		light_contrast: { label: "Claro de alto contraste" },
		dark_contrast: { label: "Oscuro de alto contraste" },
...
//# sourceMappingURL=translations-B1PCm7rE.js.map