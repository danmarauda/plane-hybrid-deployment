//#region src/locales/ro/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Parola curentă" },
				new_password: {
					label: "Parolă nouă",
		...
		sign_up: {
			...
			errors: { password: { strength: "Setează o parolă puternică pentru a continua" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Se pare că administratorul nu a activat SMTP, nu putem trimite link-ul de resetare a parolei" },
			toast: {
				success: {
					title: "Email trimis",
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Gestionează mini-aplicațiile" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Noutăți în Plane" },
		quick_tutorial: { title: "Tutorial rapid" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Eroare la preluarea {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Sarcină majoră creată cu succes" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Elimină activitatea părinte" }
		},
		new: "Activitate nouă",
		adding: "Se adaugă activitatea",
		create: { success: "Activitatea a fost creată cu succes" },
		priority: {
			urgent: "Urgentă",
			high: "Ridicată",
			medium: "Medie",
		...
		comments: {
			...
			upload: { error: "Încărcarea fișierului a eșuat. Te rugăm să încerci mai târziu." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Vezi alte activități" }
		} },
		sibling: { label: "Activități înrudite" },
		archive: {
			...
			failed: { message: "Activitatea nu a putut fi arhivată. Te rugăm să încerci din nou." }
		},
		restore: {
			success: {
			...
			failed: { message: "Activitatea nu a putut fi restaurată. Te rugăm să încerci din nou." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Creează perspectivă" },
		update: { label: "Actualizează perspectiva" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		empty_state: {
			...
			detail: { title: "Selectează o cerere pentru a-i vedea detaliile." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# lună} other{# luni}}" },
		empty_state: {
			general: {
			...
			search: { description: "Nu s-au găsit proiecte care să corespundă criteriilor.\nCreează un proiect nou." }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Creează o nouă activitate" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Dacă confirmați, toate opțiunile de sortare, filtrare și afișare + aspectul pe care l-ați ales pentru această vizualizare vor fi șterse permanent fără nicio modalitate de a le restaura."
		}
	},
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Cheia secretă a fost copiată în memoria temporară." },
					secret_key_not_copied: { message: "A apărut o eroare la copierea cheii secrete." }
				}
			},
			api_tokens: {
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "Eroare la actualizarea etichetei" }
		},
		estimates: {
			label: "Estimări",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Ciclu viitor" },
		completed_cycle: { label: "Ciclu finalizat" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Ai deja un ciclu în datele selectate. Dacă vrei să creezi o schiță, poți face asta eliminând ambele date." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Creează o activitate nouă" },
				secondary_button: { text: "Adaugă o activitate existentă" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Setează automatizarea" }
		},
		issues_empty_filter: {
			title: "Nicio activitate găsită conform filtrelor aplicate",
			secondary_button: { text: "Șterge toate filtrele" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Creează activități noi" },
				secondary_button: { text: "Adaugă o activitate existentă" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Link-ul modulului a fost copiat în memoria temporară" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Creează primul tău document" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "Niciun rezultat găsit" } } },
	issue_relation: { empty_state: {
		search: { title: "Nu au fost găsite activități potrivite" },
		no_issues: { title: "Nu au fost găsite activități" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Selectează pentru a vedea detalii." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "Adaugă activități în ciclu pentru a vedea progresul" },
		chart: { title: "Adaugă activități în ciclu pentru a vedea graficul de finalizare a activităților." },
		priority_issue: { title: "Observă rapid activitățile cu prioritate ridicată abordate în ciclu." },
		assignee: { title: "Adaugă responsabili pentru a vedea repartizarea muncii pe persoane." },
		label: { title: "Adaugă etichete activităților pentru a vedea repartizarea muncii pe etichete." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Gestionează funcțiile" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Creează prima ta schiță" }
		},
		delete_modal: {
			title: "Șterge schița",
		...
		toasts: {
			...
			deleted: { success: "Schiță ștearsă" }
		}
	},
	stickies: {
		title: "Notițele tale",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Adaugă notiță" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Preferință sistem" },
		light: { label: "Luminos" },
		dark: { label: "Întunecat" },
		light_contrast: { label: "Luminos cu contrast ridicat" },
		dark_contrast: { label: "Întunecat cu contrast ridicat" },
		custom: { label: "Temă personalizată" }
	} },
	project_modules: {
		status: {
			backlog: "Restante",
...
//# sourceMappingURL=translations-Pvu3yt-a.js.map