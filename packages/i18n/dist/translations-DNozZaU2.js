//#region src/locales/ko/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "현재 비밀번호" },
				new_password: {
					label: "새 비밀번호",
		...
		sign_up: {
			...
			errors: { password: { strength: "강력한 비밀번호를 설정하여 진행하세요" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "SMTP가 활성화되지 않았습니다. 비밀번호 재설정 링크를 보낼 수 없습니다." },
			toast: {
				success: {
					title: "이메일 전송됨",
	...
	home: {
		...
		new_at_plane: { title: "Plane의 새로운 기능" },
		quick_tutorial: { title: "빠른 튜토리얼" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "{entity}를 가져오는 중 오류 발생" },
		add: {
	...
	epic: {
		...
		new: "새 에픽",
		adding: "에픽 추가 중",
		create: { success: "에픽이 성공적으로 생성되었습니다" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "상위 작업 항목 제거" }
		},
		new: "새 작업 항목",
		adding: "작업 항목 추가 중",
		create: { success: "작업 항목이 성공적으로 생성되었습니다" },
		priority: {
			urgent: "긴급",
			high: "높음",
			medium: "중간",
		...
		comments: {
			...
			upload: { error: "자산 업로드 실패. 나중에 다시 시도해주세요." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "다른 작업 항목 보기" }
		} },
		sibling: { label: "형제 작업 항목" },
		archive: {
			...
			failed: { message: "작업 항목을 아카이브할 수 없습니다. 다시 시도해주세요." }
		},
		restore: {
			success: {
				title: "복원 성공",
			...
			failed: { message: "작업 항목을 복원할 수 없습니다. 다시 시도해주세요." }
		},
		relation: {
			relates_to: "관련 있음",
			duplicate: "중복",
	...
	inbox_issue: {
		...
		empty_state: {
			...
			detail: { title: "작업 항목의 세부 정보를 보려면 선택하세요." }
		}
	},
	workspace_creation: {
		heading: "작업 공간 생성",
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# 개월} other{# 개월}}" },
		empty_state: {
			general: {
				title: "활성 프로젝트 없음",
			...
			search: { description: "일치하는 프로젝트가 없습니다. 대신 새 프로젝트를 생성하세요" }
		}
	},
	workspace_views: {
		add_view: "뷰 추가",
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "새 작업 항목 생성" }
			},
			assigned: {
				title: "작업 항목 없음",
		...
		delete_view: {
			title: "이 뷰를 삭제하시겠습니까?",
			content: "확인하면 이 뷰에 대해 선택한 모든 정렬, 필터 및 표시 옵션 + 레이아웃이 복원할 수 없는 방식으로 영구적으로 삭제됩니다."
		}
	},
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "비밀 키가 클립보드에 복사되었습니다." },
					secret_key_not_copied: { message: "비밀 키를 복사하는 중 오류가 발생했습니다." }
				}
			},
			api_tokens: {
				title: "API 토큰",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "다가오는 주기" },
		completed_cycle: { label: "완료된 주기" },
		status: {
			days_left: "남은 일수",
			completed: "완료됨",
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "주어진 날짜에 이미 주기가 있습니다. 초안 주기를 생성하려면 두 날짜를 모두 제거하세요." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "새 작업 항목 생성" },
				secondary_button: { text: "기존 작업 항목 추가" }
			},
			completed_no_issues: {
				title: "주기에 작업 항목 없음",
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "자동화 설정" }
		},
		issues_empty_filter: {
			title: "적용된 필터와 일치하는 작업 항목 없음",
			secondary_button: { text: "모든 필터 지우기" }
		}
	} },
	project_module: {
		add_module: "모듈 추가",
		...
		toast: {
			copy: { success: "모듈 링크가 클립보드에 복사되었습니다" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "첫 번째 페이지 생성" }
		},
		private: {
			title: "비공개 페이지 없음",
	...
	command_k: { empty_state: { search: { title: "결과 없음" } } },
	issue_relation: { empty_state: {
		search: { title: "일치하는 작업 항목 없음" },
		no_issues: { title: "작업 항목 없음" }
	} },
	...
	active_cycle: { empty_state: {
		progress: { title: "주기에 작업 항목을 추가하여 진행 상황을 확인하세요" },
		chart: { title: "주기에 작업 항목을 추가하여 버다운 차트를 확인하세요." },
		priority_issue: { title: "주기에서 처리된 고우선 작업 항목을 한눈에 확인하세요." },
		assignee: { title: "작업 항목에 담당자를 추가하여 담당자별 작업 분포를 확인하세요." },
		label: { title: "작업 항목에 레이블을 추가하여 레이블별 작업 분포를 확인하세요." }
	} },
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "첫 번째 초안 생성" }
		},
		delete_modal: {
			title: "초안 삭제",
	...
	themes: { theme_options: {
		system_preference: { label: "시스템 기본값" },
		light: { label: "라이트" },
		dark: { label: "다크" },
		light_contrast: { label: "라이트 고대비" },
		dark_contrast: { label: "다크 고대비" },
		custom: { label: "사용자 정의 테마" }
	} },
	project_modules: {
		status: {
			backlog: "백로그",
...
//# sourceMappingURL=translations-DNozZaU2.js.map