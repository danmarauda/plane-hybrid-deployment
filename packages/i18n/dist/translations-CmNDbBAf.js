//#region src/locales/ja/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "現在のパスワード" },
				new_password: {
					label: "新しいパスワード",
		...
		sign_up: {
			...
			errors: { password: { strength: "強力なパスワードを設定して続行してください" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "管理者がSMTPを有効にしていないため、パスワードリセットリンクを送信できません" },
			toast: {
				success: {
					title: "メール送信完了",
	...
	home: {
		...
		new_at_plane: { title: "Planeの新機能" },
		quick_tutorial: { title: "クイックチュートリアル" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "{entity}の取得中にエラーが発生しました" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "親作業項目を削除" }
		},
		new: "新規作業項目",
		adding: "作業項目を追加中",
		create: { success: "作業項目を作成しました" },
		priority: {
			urgent: "緊急",
			high: "高",
			medium: "中",
		...
		comments: {
			...
			upload: { error: "アセットのアップロードに失敗しました。後でもう一度お試しください。" },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "他の作業項目を表示" }
		} },
		sibling: { label: "兄弟作業項目" },
		archive: {
			...
			failed: { message: "作業項目をアーカイブできませんでした。もう一度お試しください。" }
		},
		restore: {
			success: {
				title: "復元成功",
			...
			failed: { message: "作業項目を復元できませんでした。もう一度お試しください。" }
		},
		relation: {
			relates_to: "関連する",
			duplicate: "重複する",
	...
	inbox_issue: {
		...
		empty_state: {
			...
			detail: { title: "詳細を表示する作業項目を選択してください。" }
		}
	},
	workspace_creation: {
		heading: "ワークスペースを作成",
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# ヶ月} other{# ヶ月}}" },
		empty_state: {
			general: {
			...
			search: { description: "条件に一致するプロジェクトが見つかりません。\n代わりに新しいプロジェクトを作成してください。" }
		}
	},
	workspace_views: {
		add_view: "ビューを追加",
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "新しい作業項目を作成" }
			},
			assigned: {
				title: "作業項目がまだありません",
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "シークレットキーがクリップボードにコピーされました。" },
					secret_key_not_copied: { message: "シークレットキーのコピー中にエラーが発生しました。" }
				}
			},
			api_tokens: {
				title: "APIトークン",
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "ラベルの更新中にエラーが発生しました" }
		},
		estimates: {
			label: "見積もり",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "今後のサイクル" },
		completed_cycle: { label: "完了したサイクル" },
		status: {
			days_left: "残り日数",
			completed: "完了",
			yet_to_start: "開始前",
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "指定した日付のサイクルは既に存在します。下書きサイクルを作成する場合は、両方の日付を削除してください。" }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "新しい作業項目を作成" },
				secondary_button: { text: "既存の作業項目を追加" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "自動化を設定" }
		},
		issues_empty_filter: {
			title: "適用されたフィルターに一致する作業項目が見つかりません",
			secondary_button: { text: "すべてのフィルターをクリア" }
		}
	} },
	project_module: {
		add_module: "モジュールを追加",
		...
		toast: {
			copy: { success: "モジュールのリンクがクリップボードにコピーされました" },
			delete: {
	...
	command_k: { empty_state: { search: { title: "結果が見つかりません" } } },
	issue_relation: { empty_state: {
		search: { title: "一致する作業項目が見つかりません" },
		no_issues: { title: "作業項目が見つかりません" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "詳細を表示するには選択してください。" },
			all: {
				title: "割り当てられた作業項目がありません",
	...
	active_cycle: { empty_state: {
		progress: { title: "サイクルの進捗を表示するには作業項目を追加してください" },
		chart: { title: "バーンダウンチャートを表示するには作業項目を追加してください。" },
		priority_issue: { title: "サイクルで取り組まれている優先度の高い作業項目を一目で確認できます。" },
		assignee: { title: "担当者別の作業の内訳を確認するには、作業項目に担当者を追加してください。" },
		label: { title: "ラベル別の作業の内訳を確認するには、作業項目にラベルを追加してください。" }
	} },
	...
	themes: { theme_options: {
		system_preference: { label: "システム設定" },
		light: { label: "ライト" },
		dark: { label: "ダーク" },
		light_contrast: { label: "ライトハイコントラスト" },
		dark_contrast: { label: "ダークハイコントラスト" },
		custom: { label: "カスタムテーマ" }
	} },
	project_modules: {
		status: {
			backlog: "バックログ",
...
//# sourceMappingURL=translations-CmNDbBAf.js.map