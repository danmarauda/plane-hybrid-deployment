//#region src/locales/tr-TR/translations.ts
var translations_default = {
	...
	auth: {
		...
		sign_up: {
			...
			errors: { password: { strength: "Devam etmek için güçlü bir şifre belirlemeyi deneyin" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Yöneticinizin SMTP'yi etkinleştirmediğini görüyoruz, bu yüzden şifre sıfırlama bağlantısı gönderemeyeceğiz" },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Widget'ları yönet" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Plane'de Yenilikler" },
		quick_tutorial: { title: "Hızlı eğitim" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "{entity} alınırken hata oluştu" },
		add: {
	...
	epic: {
		...
		create: { success: "Epik başarıyla oluşturuldu" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Üst iş öğesini kaldır" }
		},
		new: "Yeni İş Öğesi",
		adding: "İş öğesi ekleniyor",
		create: { success: "İş öğesi başarıyla oluşturuldu" },
		priority: {
			urgent: "Acil",
			high: "Yüksek",
			medium: "Orta",
		...
		comments: {
			...
			upload: { error: "Dosya yüklenemedi. Lütfen daha sonra tekrar deneyin." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Diğer iş öğelerini görüntüle" }
		} },
		sibling: { label: "Kardeş iş öğeleri" },
		archive: {
			...
			failed: { message: "İş öğesi arşivlenemedi. Lütfen tekrar deneyin." }
		},
		restore: {
			success: {
			...
			failed: { message: "İş öğesi geri yüklenemedi. Lütfen tekrar deneyin." }
		},
		relation: {
			relates_to: "İlişkili",
			duplicate: "Kopyası",
	...
	view: {
		...
		create: { label: "Görünüm Oluştur" },
		update: { label: "Görünümü Güncelle" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Talep iş öğesi oluştur" },
		tabs: {
			open: "Açık",
			closed: "Kapalı"
		},
		empty_state: {
			...
			detail: { title: "Detaylarını görüntülemek için bir iş öğesi seçin." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# ay} other{# ay}}" },
		empty_state: {
			general: {
			...
			search: { description: "Eşleşen kriterlerle proje bulunamadı.\nBunun yerine yeni bir proje oluşturun" }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Yeni iş öğesi oluştur" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Onaylarsanız, bu görünüm için seçtiğiniz tüm sıralama, filtreleme ve görüntüleme seçenekleri + düzen kalıcı olarak silinecek ve geri yükleme imkanı olmayacaktır."
		}
	},
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Gizli anahtar panoya kopyalandı." },
					secret_key_not_copied: { message: "Gizli anahtar kopyalanırken hata oluştu." }
				}
			},
			api_tokens: {
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Yaklaşan döngü" },
		completed_cycle: { label: "Tamamlanan döngü" },
		status: {
			days_left: "Kalan gün",
			completed: "Tamamlandı",
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Belirtilen tarihlerde zaten bir döngünüz var, taslak bir döngü oluşturmak istiyorsanız, her iki tarihi de kaldırarak oluşturabilirsiniz." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Yeni iş öğesi oluştur" },
				secondary_button: { text: "Varolan iş öğesi ekle" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Otomasyon ayarla" }
		},
		issues_empty_filter: {
			title: "Uygulanan filtrelerle eşleşen iş öğesi bulunamadı",
			secondary_button: { text: "Tüm filtreleri temizle" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Yeni iş öğeleri oluştur" },
				secondary_button: { text: "Varolan bir iş öğesi ekle" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Modül bağlantısı panoya kopyalandı" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "İlk sayfanızı oluşturun" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "Sonuç bulunamadı" } } },
	issue_relation: { empty_state: {
		search: { title: "Eşleşen iş öğesi bulunamadı" },
		no_issues: { title: "İş öğesi bulunamadı" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Detayları görüntülemek için seçin." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "İlerlemeyi görüntülemek için döngüye iş öğeleri ekleyin" },
		chart: { title: "Burndown grafiğini görüntülemek için döngüye iş öğeleri ekleyin." },
		priority_issue: { title: "Döngüde ele alınan yüksek öncelikli iş öğelerini bir bakışta görün." },
		assignee: { title: "Atananları iş öğelerine ekleyerek iş dağılımını görün." },
	...
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Özellikleri yönet" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "İlk taslağınızı oluşturun" }
		},
		delete_modal: {
			title: "Taslağı sil",
		...
		toasts: {
			...
			deleted: { success: "Taslak silindi" }
		}
	},
	stickies: {
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Yapışkan not ekle" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Sistem tercihi" },
		light: { label: "Açık" },
		dark: { label: "Koyu" },
		light_contrast: { label: "Yüksek kontrastlı açık" },
		dark_contrast: { label: "Yüksek kontrastlı koyu" },
		custom: { label: "Özel tema" }
	} },
	project_modules: {
		status: {
			backlog: "Bekleme Listesi",
...
//# sourceMappingURL=translations-EBMywXIF.js.map