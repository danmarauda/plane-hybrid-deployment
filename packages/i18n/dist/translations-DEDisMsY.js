//#region src/locales/cs/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Aktuální heslo" },
				new_password: {
					label: "Nové heslo",
		...
		sign_up: {
			...
			errors: { password: { strength: "Zkuste nastavit silné heslo, abyste mohli pokračovat" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Vidíme, že váš správce neaktivoval SMTP, nebudeme schopni odeslat odkaz na obnovení hesla" },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Spravovat widgety" }
			}
		},
		quick_links: {
		...
		quick_tutorial: { title: "Rychlý tutoriál" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Chyba při načítání {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epik úspěšně vytvořen" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Odebrat nadřazenou pracovní položku" }
		},
		new: "Nová pracovní položka",
		adding: "Přidávání pracovní položky",
		create: { success: "Pracovní položka úspěšně vytvořena" },
		priority: {
			urgent: "Naléhavá",
			high: "Vysoká",
			medium: "Střední",
		...
		comments: {
			...
			upload: { error: "Nahrání přílohy se nezdařilo. Zkuste to prosím později." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Zobrazit další pracovní položky" }
		} },
		sibling: { label: "Související pracovní položky" },
		archive: {
			...
			failed: { message: "Archivace pracovní položky se nezdařila. Zkuste to prosím znovu." }
		},
		restore: {
			success: {
			...
			failed: { message: "Obnovení pracovní položky se nezdařilo. Zkuste to prosím znovu." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Vytvořit pohled" },
		update: { label: "Aktualizovat pohled" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Vytvořit přijatou pracovní položku" },
		tabs: {
			open: "Otevřené",
			closed: "Uzavřené"
		},
		empty_state: {
			...
			detail: { title: "Vyberte pracovní položku pro zobrazení podrobností." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# měsíc} few{# měsíce} other{# měsíců}}" },
		empty_state: {
			general: {
			...
			search: { description: "Nenalezeny projekty odpovídající kritériím.\nVytvořte nový." }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Vytvořit pracovní položku" }
			},
			assigned: {
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Tajný klíč zkopírován do schránky." },
					secret_key_not_copied: { message: "Chyba při kopírování klíče." }
				}
			},
			api_tokens: {
				title: "API Tokeny",
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "Chyba při aktualizaci štítku" }
		},
		estimates: {
			label: "Odhady",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Nadcházející cyklus" },
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Cyklus s těmito daty již existuje. Pro koncept odstraňte data." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Vytvořit položku" },
				secondary_button: { text: "Přidat existující položku" }
			},
			completed_no_issues: {
				title: "Žádné položky v cyklu",
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Nastavit automatizaci" }
		},
		issues_empty_filter: {
			title: "Žádné odpovídající položky",
			secondary_button: { text: "Vymazat filtry" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Vytvořit položky" },
				secondary_button: { text: "Přidat existující položku" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Odkaz na modul zkopírován" },
			delete: {
	...
	command_k: { empty_state: { search: { title: "Nenalezeny výsledky" } } },
	issue_relation: { empty_state: {
		search: { title: "Žádné odpovídající položky" },
		no_issues: { title: "Žádné položky" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Vyberte pro podrobnosti." },
			all: {
				title: "Žádné přiřazené položky",
	...
	active_cycle: { empty_state: {
		progress: { title: "Přidejte položky pro sledování pokroku" },
		chart: { title: "Přidejte položky pro zobrazení burndown grafu." },
		priority_issue: { title: "Zobrazí se vysoce prioritní položky." },
		assignee: { title: "Přiřaďte položky pro přehled přiřazení." },
		label: { title: "Přidejte štítky pro analýzu podle štítků." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Spravovat funkce" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Vytvořit první koncept" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Koncept smazán" }
		}
	},
	stickies: {
		title: "Vaše poznámky",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Přidat poznámku" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Systémové předvolby" },
		light: { label: "Světlé" },
		dark: { label: "Tmavé" },
		light_contrast: { label: "Světlý vysoký kontrast" },
		dark_contrast: { label: "Tmavý vysoký kontrast" },
		custom: { label: "Vlastní téma" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-DEDisMsY.js.map