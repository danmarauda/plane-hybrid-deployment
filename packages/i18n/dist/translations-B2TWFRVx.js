//#region src/locales/it/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Password attuale" },
				new_password: {
		...
		sign_up: {
			...
			errors: { password: { strength: "Prova a impostare una password forte per procedere" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Vediamo che il tuo amministratore non ha abilitato SMTP, non saremo in grado di inviare un link di reimpostazione della password" },
			toast: {
				success: {
					title: "Email inviata",
	...
	project_id_tooltip_content: "Ti aiuta a identificare in modo univoco gli elementi di lavoro nel progetto. Massimo 10 caratteri.",
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Gestisci widget" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Novità su Plane" },
		quick_tutorial: { title: "Tutorial rapido" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Errore durante il recupero di {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epic creato con successo" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Rimuovi elemento di lavoro principale" }
		},
		new: "Nuovo elemento di lavoro",
		adding: "Aggiunta dell'elemento di lavoro in corso",
		create: { success: "Elemento di lavoro creato con successo" },
		priority: {
			urgent: "Urgente",
			high: "Alta",
			medium: "Media",
		...
		comments: {
			...
			upload: { error: "Caricamento dell'asset fallito. Per favore, riprova più tardi." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Visualizza altri elementi di lavoro" }
		} },
		sibling: { label: "Elementi di lavoro correlati" },
		archive: {
			...
			failed: { message: "Impossibile archiviare l'elemento di lavoro. Per favore, riprova." }
		},
		restore: {
			success: {
			...
			failed: { message: "Impossibile ripristinare l'elemento di lavoro. Per favore, riprova." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Crea visualizzazione" },
		update: { label: "Aggiorna visualizzazione" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Crea elemento di lavoro per l'accoglienza" },
		tabs: {
			open: "Aperto",
			closed: "Chiuso"
		},
		empty_state: {
			...
			detail: { title: "Seleziona un elemento di lavoro per visualizzarne i dettagli." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		create: { label: "Aggiungi progetto" },
		network: {
			label: "Rete",
			private: {
				title: "Privato",
		...
		common: { months_count: "{months, plural, one {# mese} other {# mesi}}" },
		empty_state: {
			general: {
			...
			search: { description: "Nessun progetto rilevato con i criteri di ricerca corrispondenti.\nCrea un nuovo progetto invece" }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Crea un nuovo elemento di lavoro" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Se confermi, tutte le opzioni di ordinamento, filtro e visualizzazione + il layout che hai scelto per questa visualizzazione saranno eliminate permanentemente senza possibilità di ripristinarle."
		}
	},
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Chiave segreta copiata negli appunti." },
					secret_key_not_copied: { message: "Errore durante la copia della chiave segreta." }
				}
			},
			api_tokens: {
				title: "Token API",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Ciclo in arrivo" },
		completed_cycle: { label: "Ciclo completato" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Hai già un ciclo nelle date indicate, se vuoi creare una bozza di ciclo, puoi farlo rimuovendo entrambe le date." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Crea un nuovo elemento di lavoro" },
				secondary_button: { text: "Aggiungi un elemento di lavoro esistente" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Imposta l'automazione" }
		},
		issues_empty_filter: {
			title: "Nessun elemento di lavoro trovato corrispondente ai filtri applicati",
			secondary_button: { text: "Cancella tutti i filtri" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Crea nuovi elementi di lavoro" },
				secondary_button: { text: "Aggiungi un elemento di lavoro esistente" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Link del modulo copiato negli appunti" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Crea la tua prima pagina" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "Nessun risultato trovato" } } },
	issue_relation: { empty_state: {
		search: { title: "Nessun elemento di lavoro corrispondente trovato" },
		no_issues: { title: "Nessun elemento di lavoro trovato" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Seleziona per visualizzare i dettagli." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "Aggiungi elementi di lavoro al ciclo per visualizzarne l'avanzamento" },
		chart: { title: "Aggiungi elementi di lavoro al ciclo per visualizzare il grafico di burndown." },
		priority_issue: { title: "Visualizza in anteprima gli elementi di lavoro ad alta priorità del ciclo." },
		assignee: { title: "Aggiungi assegnatari agli elementi di lavoro per vedere la ripartizione per assegnatario." },
		label: { title: "Aggiungi etichette agli elementi di lavoro per vedere la ripartizione per etichette." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Gestisci funzionalità" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Crea la tua prima bozza" }
		},
		delete_modal: {
			title: "Elimina bozza",
		...
		toasts: {
			...
			deleted: { success: "Bozza eliminata" }
		}
	},
	stickies: {
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Aggiungi sticky" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Preferenza di sistema" },
		light: { label: "Chiaro" },
		dark: { label: "Scuro" },
		light_contrast: { label: "Contrasto elevato chiaro" },
		dark_contrast: { label: "Contrasto elevato scuro" },
		custom: { label: "Tema personalizzato" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-B2TWFRVx.js.map