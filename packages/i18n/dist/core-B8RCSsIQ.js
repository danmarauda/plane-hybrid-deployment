...
var core_default = {
	...
	auth: {
		...
		sign_up: {
			...
			errors: { password: { strength: "Try setting-up a strong password to proceed" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "We see that your god hasn't enabled SMTP, we will not be able to send a password reset link" },
			toast: {
				success: {
					title: "Email sent",
...
//# sourceMappingURL=core-B8RCSsIQ.js.map