//#region src/locales/de/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Aktuelles Passwort" },
				new_password: {
		...
		sign_up: {
			...
			errors: { password: { strength: "Versuchen Sie, ein starkes Passwort zu wählen, um fortzufahren" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Wir sehen, dass Ihr Administrator SMTP nicht aktiviert hat; wir können keinen Link zum Zurücksetzen des Passworts senden." },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Widgets verwalten" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Neu in Plane" },
		quick_tutorial: { title: "Schnelles Tutorial" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Fehler beim Laden von {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epik erfolgreich erstellt" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Übergeordnetes Arbeitselement entfernen" }
		},
		new: "Neues Arbeitselement",
		adding: "Arbeitselement wird hinzugefügt",
		create: { success: "Arbeitselement erfolgreich erstellt" },
		priority: {
			urgent: "Dringend",
			high: "Hoch",
			medium: "Mittel",
		...
		comments: {
			...
			upload: { error: "Anhang konnte nicht hochgeladen werden. Bitte versuchen Sie es später erneut." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Weitere Arbeitselemente anzeigen" }
		} },
		sibling: { label: "Verwandte Arbeitselemente" },
		archive: {
			...
			failed: { message: "Archivierung des Arbeitselements fehlgeschlagen. Bitte versuchen Sie es erneut." }
		},
		restore: {
			success: {
			...
			failed: { message: "Wiederherstellung des Arbeitselements fehlgeschlagen. Bitte versuchen Sie es erneut." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Ansicht erstellen" },
		update: { label: "Ansicht aktualisieren" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Angenommenes Arbeitselement erstellen" },
		tabs: {
			open: "Offen",
			closed: "Geschlossen"
		},
		empty_state: {
			...
			detail: { title: "Wählen Sie ein Arbeitselement, um Details anzuzeigen." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		create: { label: "Projekt hinzufügen" },
		network: {
			label: "Netzwerk",
			private: {
				title: "Privat",
		...
		common: { months_count: "{months, plural, one{# Monat} few{# Monate} other{# Monate}}" },
		empty_state: {
			general: {
			...
			search: { description: "Keine Projekte entsprechen Ihren Suchkriterien.\nErstellen Sie ein neues." }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Arbeitselement erstellen" }
			},
			assigned: {
	...
	workspace_settings: {
		...
		settings: {
			...
			exports: {
				...
				filters_info: "Wenden Sie Filter an, um bestimmte Arbeitselemente basierend auf Ihren Kriterien zu exportieren.",
				modal: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Geheimer Schlüssel in die Zwischenablage kopiert." },
					secret_key_not_copied: { message: "Fehler beim Kopieren des Schlüssels." }
				}
			},
			api_tokens: {
				title: "API-Tokens",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Bevorstehender Zyklus" },
		completed_cycle: { label: "Abgeschlossener Zyklus" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Ein Zyklus mit diesen Daten existiert bereits. Entfernen Sie das Datum für einen Entwurf." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Element erstellen" },
				secondary_button: { text: "Vorhandenes Element hinzufügen" }
			},
			completed_no_issues: {
				title: "Keine Elemente im Zyklus",
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Automatisierung einrichten" }
		},
		issues_empty_filter: {
			title: "Keine passenden Elemente",
			secondary_button: { text: "Filter löschen" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Elemente erstellen" },
				secondary_button: { text: "Vorhandenes Element hinzufügen" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Link zum Modul kopiert" },
			delete: {
	...
	command_k: { empty_state: { search: { title: "Keine Ergebnisse gefunden" } } },
	issue_relation: { empty_state: {
		search: { title: "Keine passenden Elemente" },
		no_issues: { title: "Keine Elemente" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Wählen Sie ein Element, um Details anzuzeigen." },
			all: {
				title: "Keine zugewiesenen Elemente",
	...
	active_cycle: { empty_state: {
		progress: { title: "Fügen Sie Elemente hinzu, um den Fortschritt zu verfolgen" },
		chart: { title: "Fügen Sie Elemente hinzu, um ein Burndown-Diagramm anzuzeigen." },
		priority_issue: { title: "Hochpriorisierte Arbeitselemente werden hier angezeigt." },
		assignee: { title: "Weisen Sie Elemente zu, um eine Übersicht der Zuweisungen zu sehen." },
		label: { title: "Fügen Sie Labels hinzu, um eine Analyse nach Labels zu erhalten." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Funktionen verwalten" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Ersten Entwurf erstellen" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Entwurf gelöscht" }
		}
	},
	stickies: {
		title: "Ihre Notizen",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Notiz hinzufügen" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Systemeinstellungen" },
		light: { label: "Hell" },
		dark: { label: "Dunkel" },
		light_contrast: { label: "Heller hoher Kontrast" },
		dark_contrast: { label: "Dunkler hoher Kontrast" },
		custom: { label: "Benutzerdefiniertes Theme" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-QmzuNDJK.js.map