//#region src/locales/sk/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Aktuálne heslo" },
				new_password: {
					label: "Nové heslo",
		...
		sign_up: {
			...
			errors: { password: { strength: "Skúste nastaviť silné heslo, aby ste mohli pokračovať" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Vidíme, že váš správca neaktivoval SMTP, nebudeme môcť odoslať odkaz na obnovenie hesla" },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Spravovať widgety" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Novinky v Plane" },
		quick_tutorial: { title: "Rýchly tutoriál" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Chyba pri načítaní {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epika bola úspešne vytvorená" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Odstrániť nadradenú pracovnú položku" }
		},
		new: "Nová pracovná položka",
		adding: "Pridávanie pracovnej položky",
		create: { success: "Pracovná položka bola úspešne vytvorená" },
		priority: {
			urgent: "Naliehavá",
			high: "Vysoká",
			medium: "Stredná",
		...
		comments: {
			...
			upload: { error: "Nahratie prílohy zlyhalo. Skúste to prosím neskôr." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Zobraziť ďalšie pracovné položky" }
		} },
		sibling: { label: "Súvisiace pracovné položky" },
		archive: {
			...
			failed: { message: "Archivácia pracovnej položky zlyhala. Skúste to prosím znova." }
		},
		restore: {
			success: {
			...
			failed: { message: "Obnovenie pracovnej položky zlyhalo. Skúste to prosím znova." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Vytvoriť pohľad" },
		update: { label: "Aktualizovať pohľad" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Vytvoriť prijatú pracovnú položku" },
		tabs: {
			open: "Otvorené",
			closed: "Uzavreté"
		},
		empty_state: {
			...
			detail: { title: "Vyberte pracovnú položku pre zobrazenie detailov." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# mesiac} few{# mesiace} other{# mesiacov}}" },
		empty_state: {
			general: {
			...
			search: { description: "Nenašli sa projekty zodpovedajúce kritériám.\nVytvorte nový." }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Vytvoriť pracovnú položku" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Ak potvrdíte, všetky možnosti triedenia, filtrovania a zobrazenia + rozloženie, ktoré ste vybrali pre toto zobrazenie, budú natrvalo vymazané bez možnosti obnovenia."
		}
	},
		...
		settings: {
			general: {
				...
				errors: {
					...
					company_size: { required: "Veľkosť spoločnosti je povinná" }
				}
			},
			members: {
				title: "Členovia",
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Tajný kľúč skopírovaný do schránky." },
					secret_key_not_copied: { message: "Chyba pri kopírovaní kľúča." }
				}
			},
			api_tokens: {
				title: "API Tokeny",
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "Chyba pri aktualizácii štítka" }
		},
		estimates: {
			label: "Odhady",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Nadchádzajúci cyklus" },
		completed_cycle: { label: "Dokončený cyklus" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Cyklus s týmito dátami už existuje. Pre koncept odstráňte dáta." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Vytvoriť položku" },
				secondary_button: { text: "Pridať existujúcu položku" }
			},
			completed_no_issues: {
				title: "Žiadne položky v cykle",
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Nastaviť automatizáciu" }
		},
		issues_empty_filter: {
			title: "Žiadne zodpovedajúce položky",
			secondary_button: { text: "Vymazať filtre" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Vytvoriť položky" },
				secondary_button: { text: "Pridať existujúcu položku" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Odkaz na modul bol skopírovaný" },
			delete: {
	...
	command_k: { empty_state: { search: { title: "Nenašli sa žiadne výsledky" } } },
	issue_relation: { empty_state: {
		search: { title: "Žiadne zodpovedajúce položky" },
		no_issues: { title: "Žiadne položky" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Vyberte pre podrobnosti." },
			all: {
				title: "Žiadne priradené položky",
	...
	active_cycle: { empty_state: {
		progress: { title: "Pridajte položky pre sledovanie pokroku" },
		chart: { title: "Pridajte položky pre zobrazenie burndown grafu." },
		priority_issue: { title: "Zobrazia sa vysoko prioritné pracovné položky." },
		assignee: { title: "Priraďte položky pre prehľad priradení." },
		label: { title: "Pridajte štítky pre analýzu podľa štítkov." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Spravovať funkcie" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Vytvoriť prvý koncept" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Koncept zmazaný" }
		}
	},
	stickies: {
		title: "Vaše poznámky",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Pridať poznámku" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Systémové predvoľby" },
		light: { label: "Svetlé" },
		dark: { label: "Tmavé" },
		light_contrast: { label: "Svetlý vysoký kontrast" },
		dark_contrast: { label: "Tmavý vysoký kontrast" },
		custom: { label: "Vlastná téma" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-DPDCnerQ.js.map