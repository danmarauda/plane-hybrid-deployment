//#region src/locales/ru/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Текущий пароль" },
				new_password: {
					label: "Новый пароль",
		...
		sign_up: {
			...
			errors: { password: { strength: "Попробуйте установить сильный пароль для продолжения" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Мы видим, что ваш администратор не включил SMTP, мы не сможем отправить ссылку для сброса пароля" },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Управление виджетами" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Новое в Plane" },
		quick_tutorial: { title: "Быстрое обучение" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Ошибка получения {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Эпик успешно создан" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Удалить родительский рабочий элемент" }
		},
		new: "Новый рабочий элемент",
		adding: "Добавление рабочего элемента",
		create: { success: "Рабочий элемент успешно создан" },
		priority: {
			urgent: "Срочный",
			high: "Высокий",
			medium: "Средний",
		...
		comments: {
			...
			upload: { error: "Ошибка загрузки файла. Попробуйте позже." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Посмотреть другие рабочие элементы" }
		} },
		sibling: { label: "Связанные рабочие элементы" },
		archive: {
			...
			failed: { message: "Ошибка архивации рабочего элемента. Попробуйте позже." }
		},
		restore: {
			success: {
			...
			failed: { message: "Ошибка восстановления рабочего элемента. Попробуйте позже." }
		},
		relation: {
			relates_to: "Связан с",
			duplicate: "Дубликат",
	...
	view: {
		...
		create: { label: "Создать представление" },
		update: { label: "Обновить представление" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Создать входящий рабочий элемент" },
		tabs: {
			open: "Открытые",
			closed: "Закрытые"
		},
		empty_state: {
			...
			detail: { title: "Выберите рабочий элемент для просмотра деталей." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# месяц} other{# месяцев}}" },
		empty_state: {
			general: {
			...
			search: { description: "Не найдено проектов по заданным критериям.\nСоздайте новый проект" }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Создать рабочий элемент" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "При подтверждении все параметры сортировки, фильтрации и отображения + макет, выбранный для этого представления, будут безвозвратно удалены без возможности восстановления."
		}
	},
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Секретный ключ скопирован" },
					secret_key_not_copied: { message: "Ошибка копирования ключа" }
				}
			},
			api_tokens: {
				title: "API-токены",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Предстоящий цикл" },
		completed_cycle: { label: "Завершённый цикл" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Цикл на указанные даты уже существует. Для создания черновика удалите даты." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Создать рабочий элемент" },
				secondary_button: { text: "Добавить существующий рабочий элемент" }
			},
			completed_no_issues: {
				title: "Нет рабочих элементов в цикле",
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Настроить автоматизацию" }
		},
		issues_empty_filter: {
			title: "Нет рабочих элементов подходящих фильтрам",
			secondary_button: { text: "Сбросить фильтры" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Создать новые рабочие элементы" },
				secondary_button: { text: "Добавить существующий рабочий элемент" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Ссылка на модуль скопирована в буфер обмена" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Создать первую страницу" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "Ничего не найдено" } } },
	issue_relation: { empty_state: {
		search: { title: "Не найдено подходящих рабочих элементов" },
		no_issues: { title: "Рабочие элементы не найдены" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Выберите для просмотра деталей" },
			all: {
				title: "Нет назначенных рабочих элементов",
	...
	active_cycle: { empty_state: {
		progress: { title: "Добавьте рабочие элементы в цикл, чтобы отслеживать прогресс" },
		chart: { title: "Добавьте рабочие элементы в цикл для построения графика выполнения" },
		priority_issue: { title: "Просматривайте рабочие элементы с высоким приоритетом в цикле" },
		assignee: { title: "Назначьте ответственных, чтобы видеть распределение рабочих элементов" },
		label: { title: "Добавьте метки, чтобы видеть распределение рабочих элементов по категориям" }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Управление функциями" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Создать первый черновик" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Черновик удалён" }
		}
	},
	stickies: {
		title: "Ваши стикеры",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Добавить стикер" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Системные настройки" },
		light: { label: "Светлая" },
		dark: { label: "Тёмная" },
		light_contrast: { label: "Светлая высококонтрастностная" },
		dark_contrast: { label: "Тёмная высокая контрастность" },
		custom: { label: "Пользовательская тема" }
	} },
	project_modules: {
		status: {
			backlog: "Бэклог",
...
//# sourceMappingURL=translations-Bhb-zHF8.js.map