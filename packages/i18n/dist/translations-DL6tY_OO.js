//#region src/locales/id/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Password saat ini" },
				new_password: {
					label: "Password baru",
		...
		sign_up: {
			...
			errors: { password: { strength: "Coba atur password yang lebih kuat untuk melanjutkan" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Kami melihat bahwa admin anda belum mengaktifkan SMTP, kami tidak dapat mengirimkan link reset password" },
			toast: {
				success: {
	...
	project_id_tooltip_content: "Membantu Anda mengidentifikasi item kerja dalam proyek secara unik. Maksimal 10 karakter.",
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Kelola widget" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Baru di Plane" },
		quick_tutorial: { title: "Tutorial cepat" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Terjadi kesalahan saat mengambil {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epik berhasil dibuat" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Hapus item kerja induk" }
		},
		new: "Item Kerja Baru",
		adding: "Menambahkan item kerja",
		create: { success: "Item kerja berhasil dibuat" },
		priority: {
			urgent: "Mendesak",
			high: "Tinggi",
			medium: "Sedang",
		...
		comments: {
			...
			upload: { error: "Gagal mengunggah aset. Silakan coba lagi nanti." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Lihat item kerja lainnya" }
		} },
		sibling: { label: "Item kerja sejawat" },
		archive: {
			...
			failed: { message: "Item kerja tidak dapat diarsipkan. Silakan coba lagi." }
		},
		restore: {
			success: {
			...
			failed: { message: "Item kerja tidak dapat dipulihkan. Silakan coba lagi." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Buat Tampilan" },
		update: { label: "Perbarui Tampilan" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Buat item kerja pendapat" },
		tabs: {
			open: "Terbuka",
			closed: "Tutup"
		},
		empty_state: {
			...
			detail: { title: "Pilih item kerja untuk melihat detailnya." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# bulan} other{# bulan}}" },
		empty_state: {
			general: {
			...
			search: { description: "Tidak ada proyek yang terdeteksi dengan kriteria yang cocok.\nBuat proyek baru sebagai gantinya" }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Buat item kerja baru" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Jika Anda mengonfirmasi, semua opsi pengurutan, filter, dan tampilan + tata letak yang telah Anda pilih untuk tampilan ini akan dihapus secara permanen tanpa cara untuk memulihkannya."
		}
	},
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Kunci rahasia disalin ke clipboard." },
					secret_key_not_copied: { message: "Terjadi kesalahan saat menyalin kunci rahasia." }
				}
			},
			api_tokens: {
				title: "Token API",
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "Kesalahan saat memperbarui label" }
		},
		estimates: {
			label: "Perkiraan",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Siklus mendatang" },
		completed_cycle: { label: "Siklus selesai" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Anda sudah memiliki siklus pada tanggal yang diberikan, jika Anda ingin membuat siklus draf, Anda dapat melakukannya dengan menghapus kedua tanggal tersebut." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Buat item kerja baru" },
				secondary_button: { text: "Tambah item kerja yang ada" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Tetapkan otomatisasi" }
		},
		issues_empty_filter: {
			title: "Tidak ada item kerja ditemukan yang cocok dengan filter yang diterapkan",
			secondary_button: { text: "Bersihkan semua filter" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Buat item kerja baru" },
				secondary_button: { text: "Tambahkan item kerja yang ada" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Tautan modul disalin ke clipboard" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Buat halaman pertama Anda" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "Tidak ada hasil ditemukan" } } },
	issue_relation: { empty_state: {
		search: { title: "Tidak ada item kerja yang cocok ditemukan" },
		no_issues: { title: "Tidak ada item kerja ditemukan" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Pilih untuk melihat detail." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "Tambahkan item kerja ke siklus untuk melihat kemajuannya" },
		chart: { title: "Tambahkan item kerja ke siklus untuk melihat grafik burndown." },
		priority_issue: { title: "Amati item kerja prioritas yang ditangani dalam siklus pada pandangan pertama." },
		assignee: { title: "Tambahkan penugasan ke item kerja untuk melihat pembagian kerja berdasarkan penugasan." },
		label: { title: "Tambahkan label ke item kerja untuk melihat pembagian kerja berdasarkan label." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Kelola fitur" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Buat draf pertama Anda" }
		},
		delete_modal: {
			title: "Hapus draf",
		...
		toasts: {
			...
			deleted: { success: "Draf berhasil dihapus" }
		}
	},
	stickies: {
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Tambah catatan tempel" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Preferensi sistem" },
		light: { label: "Cerah" },
		dark: { label: "Gelap" },
		light_contrast: { label: "Cerah kontras tinggi" },
		dark_contrast: { label: "Gelap kontras tinggi" },
		custom: { label: "Tema kustom" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-DL6tY_OO.js.map