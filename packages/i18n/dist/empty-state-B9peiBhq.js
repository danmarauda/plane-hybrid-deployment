//#region src/locales/de/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "Wählen Sie ein Intake-Arbeitselement aus, um seine Details anzuzeigen" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "Halten Sie wichtige Referenzen, Ressourcen oder Dokumente für Ihre Arbeit griffbereit" },
		inbox_sidebar_all: { title: "Updates für Ihre abonnierten Arbeitselemente werden hier angezeigt" },
		inbox_sidebar_mentions: { title: "Erwähnungen für Ihre Arbeitselemente werden hier angezeigt" },
		your_work_by_priority: { title: "Noch kein Arbeitselement zugewiesen" },
		your_work_by_state: { title: "Noch kein Arbeitselement zugewiesen" },
		views: {
		...
		analytics_projects: { title: "Erstellen Sie Projekte, um hier Projektmetriken zu visualisieren." },
		analytics_work_items: { title: "Erstellen Sie Projekte mit Arbeitselementen und Zugewiesenen, um hier Leistung, Fortschritt und Teameinfluss zu verfolgen." },
		analytics_no_cycle: { title: "Erstellen Sie Zyklen, um Arbeit in zeitlich begrenzte Phasen zu organisieren und Fortschritte über Sprints hinweg zu verfolgen." },
		analytics_no_module: { title: "Erstellen Sie Module, um Ihre Arbeit zu organisieren und Fortschritte über verschiedene Phasen hinweg zu verfolgen." },
		analytics_no_intake: { title: "Richten Sie Intake ein, um eingehende Anfragen zu verwalten und zu verfolgen, wie sie akzeptiert und abgelehnt werden" }
	},
...
//# sourceMappingURL=empty-state-B9peiBhq.js.map