//#region src/locales/ro/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "Selectați un element de lucru de Admitere pentru a vedea detaliile" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "Păstrați referințe importante, resurse sau documente la îndemână pentru munca dvs." },
		inbox_sidebar_all: { title: "Actualizările pentru elementele dvs. de lucru la care sunteți abonat vor apărea aici" },
		inbox_sidebar_mentions: { title: "Mențiunile pentru elementele dvs. de lucru vor apărea aici" },
		your_work_by_priority: { title: "Încă nu există elemente de lucru atribuite" },
		your_work_by_state: { title: "Încă nu există elemente de lucru atribuite" },
		views: {
		...
		analytics_projects: { title: "Creați proiecte pentru a vizualiza metricile proiectului aici." },
		analytics_work_items: { title: "Creați proiecte cu elemente de lucru și responsabili pentru a începe urmărirea performanței, progresului și impactului echipei aici." },
		analytics_no_cycle: { title: "Creați cicluri pentru a organiza munca în faze limitate în timp și a urmări progresul în sprint-uri." },
		analytics_no_module: { title: "Creați module pentru a vă organiza munca și a urmări progresul în diferite etape." },
		analytics_no_intake: { title: "Configurați admiterea pentru a gestiona solicitările primite și a urmări cum sunt acceptate și respinse" }
	},
...
//# sourceMappingURL=empty-state-Dku1Pk_I.js.map