//#region src/locales/ua/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Поточний пароль" },
				new_password: {
					label: "Новий пароль",
		...
		sign_up: {
			...
			errors: { password: { strength: "Спробуйте встановити надійний пароль, щоб продовжити" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Адміністратор не активував SMTP, тому неможливо надіслати посилання для відновлення пароля" },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Керувати віджетами" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Новинки в Plane" },
		quick_tutorial: { title: "Швидкий посібник" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Помилка під час завантаження {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Епік успішно створено" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Вилучити батьківську робочу одиницю" }
		},
		new: "Нова робоча одиниця",
		adding: "Додавання робочої одиниці",
		create: { success: "Робочу одиницю успішно створено" },
		priority: {
			urgent: "Терміновий",
			high: "Високий",
			medium: "Середній",
		...
		comments: {
			...
			upload: { error: "Не вдалося завантажити вкладення. Спробуйте пізніше." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Переглянути інші робочі одиниці" }
		} },
		sibling: { label: "Пов’язані робочі одиниці" },
		archive: {
			...
			failed: { message: "Не вдалося заархівувати робочу одиницю. Спробуйте ще раз." }
		},
		restore: {
			success: {
			...
			failed: { message: "Не вдалося відновити робочу одиницю. Спробуйте ще раз." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Створити подання" },
		update: { label: "Оновити подання" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Створити прийняту робочу одиницю" },
		tabs: {
			open: "Відкриті",
			closed: "Закриті"
		},
		empty_state: {
			...
			detail: { title: "Виберіть робочу одиницю для перегляду деталей." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# місяць} few{# місяці} other{# місяців}}" },
		empty_state: {
			general: {
			...
			search: { description: "Не знайдено проєктів, що відповідають критеріям.\nСтворіть новий." }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Створити робочу одиницю" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Якщо ви підтвердите, всі параметри сортування, фільтрації та відображення + макет, який ви обрали для цього подання, будуть безповоротно видалені без можливості відновлення."
		}
	},
		...
		settings: {
			general: {
				...
				errors: {
					...
					company_size: { required: "Розмір компанії є обов’язковим" }
				}
			},
			members: {
				title: "Учасники",
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Секретний ключ скопійовано до буфера." },
					secret_key_not_copied: { message: "Помилка під час копіювання ключа." }
				}
			},
			api_tokens: {
				title: "API токени",
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "Помилка під час оновлення мітки" }
		},
		estimates: {
			label: "Оцінки",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Майбутній цикл" },
		completed_cycle: { label: "Завершений цикл" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Цикл із цими датами вже існує. Для чернетки видаліть дати." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Створити одиницю" },
				secondary_button: { text: "Додати наявну одиницю" }
			},
			completed_no_issues: {
				title: "У циклі немає робочих одиниць",
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Налаштувати автоматизацію" }
		},
		issues_empty_filter: {
			title: "Немає одиниць за цим фільтром",
			secondary_button: { text: "Скинути фільтри" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Створити одиниці" },
				secondary_button: { text: "Додати наявну одиницю" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Посилання на модуль скопійовано" },
			delete: {
	...
	command_k: { empty_state: { search: { title: "Немає результатів" } } },
	issue_relation: { empty_state: {
		search: { title: "Немає відповідних одиниць" },
		no_issues: { title: "Немає одиниць" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Виберіть елемент, щоб побачити деталі." },
			all: {
				title: "Немає призначених одиниць",
	...
	active_cycle: { empty_state: {
		progress: { title: "Додайте одиниці, щоб відстежувати прогрес" },
		chart: { title: "Додайте одиниці, щоб побачити burndown-графік." },
		priority_issue: { title: "Тут з’являться найпріоритетніші робочі одиниці." },
		assignee: { title: "Призначте робочі одиниці, щоб побачити розподіл." },
		label: { title: "Додайте мітки, щоб аналізувати за мітками." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Керувати функціями" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Створити першу чернетку" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Чернетку видалено" }
		}
	},
	stickies: {
		title: "Ваші нотатки",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Додати нотатку" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Системні налаштування" },
		light: { label: "Світла" },
		dark: { label: "Темна" },
		light_contrast: { label: "Світла з високою контрастністю" },
...
//# sourceMappingURL=translations-BDoRpFv7.js.map