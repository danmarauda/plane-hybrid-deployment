//#region src/locales/cs/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "Vyberte příchozí pracovní položku pro zobrazení jejích podrobností" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "Mějte po ruce důležité odkazy, zdroje nebo dokumenty pro vaši práci" },
		inbox_sidebar_all: { title: "Aktualizace pro vaše odebírané pracovní položky se zobrazí zde" },
		inbox_sidebar_mentions: { title: "Zmínky o vašich pracovních položkách se zobrazí zde" },
		your_work_by_priority: { title: "Zatím není přiřazena žádná pracovní položka" },
		your_work_by_state: { title: "Zatím není přiřazena žádná pracovní položka" },
		views: {
		...
		analytics_projects: { title: "Vytvořte projekty pro vizualizaci metrik projektu zde." },
		analytics_work_items: { title: "Vytvořte projekty s pracovními položkami a přiřazenými osobami pro zahájení sledování výkonu, pokroku a dopadu týmu zde." },
		analytics_no_cycle: { title: "Vytvořte cykly pro organizaci práce do časově omezených fází a sledování pokroku napříč sprinty." },
		analytics_no_module: { title: "Vytvořte moduly pro organizaci své práce a sledování pokroku napříč různými fázemi." },
		analytics_no_intake: { title: "Nastavte příjem pro správu příchozích požadavků a sledování, jak jsou přijímány a odmítány" }
	},
...
//# sourceMappingURL=empty-state-CrcBeIbI.js.map