//#region src/locales/ja/empty-state.ts
var empty_state_default = {
	...
	project_empty_state: {
		...
		intake_main: { title: "インテーク作業項目を選択して詳細を表示" }
	},
	workspace_empty_state: {
		...
		home_widget_quick_links: { title: "作業に重要な参照、リソース、またはドキュメントを手元に保管" },
		inbox_sidebar_all: { title: "購読している作業項目の更新がここに表示されます" },
		inbox_sidebar_mentions: { title: "作業項目でのメンションがここに表示されます" },
		your_work_by_priority: { title: "割り当てられた作業項目はまだありません" },
		your_work_by_state: { title: "割り当てられた作業項目はまだありません" },
		views: {
			title: "ビューはまだありません",
		...
		analytics_projects: { title: "プロジェクトを作成して、ここでプロジェクトメトリクスを視覚化します。" },
		analytics_work_items: { title: "作業項目と担当者を含むプロジェクトを作成して、パフォーマンス、進捗、チームの影響をここで追跡開始します。" },
		analytics_no_cycle: { title: "サイクルを作成して、作業を期限付きフェーズに整理し、スプリント全体の進捗を追跡します。" },
		analytics_no_module: { title: "モジュールを作成して、作業を整理し、さまざまな段階での進捗を追跡します。" },
		analytics_no_intake: { title: "インテークを設定して、受信リクエストを管理し、承認と拒否を追跡します" }
	},
...
//# sourceMappingURL=empty-state-Bz380OY7.js.map