//#region src/locales/fr/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Mot de passe actuel" },
				new_password: {
		...
		sign_up: {
			...
			errors: { password: { strength: "Essayez de définir un mot de passe fort pour continuer" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Nous constatons que votre administrateur n’a pas activé le SMTP, nous ne pourrons pas envoyer de lien de réinitialisation du mot de passe" },
			toast: {
				success: {
					title: "E-mail envoyé",
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Gérer les widgets" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Nouveau sur Plane" },
		quick_tutorial: { title: "Tutoriel rapide" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Erreur lors de la récupération de {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epic créé avec succès" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Supprimer l’élément de travail parent" }
		},
		new: "Nouvel élément de travail",
		adding: "Ajout d’un élément de travail",
		create: { success: "Élément de travail créé avec succès" },
		priority: {
			urgent: "Urgent",
			high: "Haute",
			medium: "Moyenne",
		...
		comments: {
			...
			upload: { error: "Échec du téléchargement du fichier. Veuillez réessayer plus tard." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Voir les autres éléments de travail" }
		} },
		sibling: { label: "Éléments de travail frères" },
		archive: {
			...
			failed: { message: "L’élément de travail n’a pas pu être archivé. Veuillez réessayer." }
		},
		restore: {
			success: {
			...
			failed: { message: "L’élément de travail n’a pas pu être restauré. Veuillez réessayer." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Créer une vue" },
		update: { label: "Mettre à jour la vue" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Créer un élément de travail Intake" },
		tabs: {
			open: "Ouvert",
			closed: "Fermé"
		},
		empty_state: {
			...
			detail: { title: "Sélectionnez un élément de travail pour voir ses détails." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		create: { label: "Ajouter un Projet" },
		network: {
			private: {
				title: "Privé",
		...
		common: { months_count: "{months, plural, one{# mois} other{# mois}}" },
		empty_state: {
			general: {
			...
			search: { description: "Aucun projet détecté avec les critères correspondants.\nCréez plutôt un nouveau projet" }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Créer un nouvel élément de travail" }
			},
			assigned: {
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Clé secrète copiée dans le presse-papiers." },
					secret_key_not_copied: { message: "Une erreur s’est produite lors de la copie de la clé secrète." }
				}
			},
			api_tokens: {
				title: "Jetons API",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Cycle à venir" },
		completed_cycle: { label: "Cycle terminé" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Vous avez déjà un cycle aux dates indiquées. Si vous souhaitez créer un cycle en brouillon, vous pouvez le faire en supprimant les deux dates." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Créer un nouvel élément de travail" },
				secondary_button: { text: "Ajouter un élément existant" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Configurer l’automatisation" }
		},
		issues_empty_filter: {
			title: "Aucun élément de travail trouvé correspondant aux filtres appliqués",
			secondary_button: { text: "Effacer tous les filtres" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Créer de nouveaux éléments de travail" },
				secondary_button: { text: "Ajouter un élément existant" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Lien du module copié dans le presse-papiers" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Créez votre première page" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "Aucun résultat trouvé" } } },
	issue_relation: { empty_state: {
		search: { title: "Aucun élément de travail correspondant trouvé" },
		no_issues: { title: "Aucun élément de travail trouvé" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Sélectionnez pour voir les détails." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "Ajoutez des éléments de travail au cycle pour voir sa progression" },
		chart: { title: "Ajoutez des éléments de travail au cycle pour voir le graphique d’avancement." },
		priority_issue: { title: "Visualisez en un coup d’œil les éléments de travail prioritaires traités dans le cycle." },
		assignee: { title: "Ajoutez des acteurs aux éléments de travail pour voir une répartition du travail par acteur." },
		label: { title: "Ajoutez des étiquettes aux éléments de travail pour voir la répartition du travail par étiquette." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Gérer les fonctionnalités" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Créez votre premier brouillon" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Brouillon supprimé" }
		}
	},
	stickies: {
		title: "Vos post-it",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Ajouter un post-it" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Préférence système" },
		light: { label: "Clair" },
		dark: { label: "Sombre" },
		light_contrast: { label: "Contraste clair élevé" },
		dark_contrast: { label: "Contraste sombre élevé" },
		custom: { label: "Thème personnalisé" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-UUNIktJQ.js.map