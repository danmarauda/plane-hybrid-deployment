//#region src/locales/pl/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Obecne hasło" },
				new_password: {
					label: "Nowe hasło",
		...
		sign_up: {
			...
			errors: { password: { strength: "Użyj silniejszego hasła, aby kontynuować" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Administrator nie włączył SMTP, nie możemy wysłać linku do resetowania hasła" },
			toast: {
				success: {
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Zarządzaj widżetami" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Co nowego w Plane" },
		quick_tutorial: { title: "Szybki samouczek" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Błąd podczas pobierania {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Epik utworzono pomyślnie" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Usuń element nadrzędny" }
		},
		new: "Nowy element pracy",
		adding: "Dodawanie elementu pracy",
		create: { success: "Element pracy utworzono pomyślnie" },
		priority: {
			urgent: "Pilny",
			high: "Wysoki",
			medium: "Średni",
		...
		comments: {
			...
			upload: { error: "Nie udało się przesłać załącznika. Spróbuj później." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Pokaż inne elementy pracy" }
		} },
		sibling: { label: "Powiązane elementy pracy" },
		archive: {
			...
			failed: { message: "Nie udało się zarchiwizować elementu pracy. Spróbuj ponownie." }
		},
		restore: {
			success: {
			...
			failed: { message: "Nie udało się przywrócić elementu pracy. Spróbuj ponownie." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Utwórz widok" },
		update: { label: "Zaktualizuj widok" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Utwórz przyjęty element pracy" },
		tabs: {
			open: "Otwarte",
			closed: "Zamknięte"
		},
		empty_state: {
			...
			detail: { title: "Wybierz element pracy, aby zobaczyć szczegóły." }
		}
	},
	workspace_creation: {
	...
	workspace_projects: {
		...
		common: { months_count: "{months, plural, one{# miesiąc} few{# miesiące} other{# miesięcy}}" },
		empty_state: {
			general: {
			...
			search: { description: "Nie znaleziono projektów spełniających kryteria.\nUtwórz nowy." }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Utwórz element pracy" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Jeśli potwierdzisz, wszystkie opcje sortowania, filtrowania i wyświetlania + układ, który wybrałeś dla tego widoku, zostaną trwale usunięte bez możliwości przywrócenia."
		}
	},
		...
		settings: {
			general: {
				...
				errors: {
					...
					company_size: { required: "Rozmiar firmy jest wymagany" }
				}
			},
			members: {
				title: "Członkowie",
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Klucz tajny skopiowany do schowka." },
					secret_key_not_copied: { message: "Błąd podczas kopiowania klucza." }
				}
			},
			api_tokens: {
				title: "Tokeny API",
	...
	project_settings: {
		...
		labels: {
			...
			toast: { error: "Błąd podczas aktualizacji etykiety" }
		},
		estimates: {
			label: "Szacunki",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Nadchodzący cykl" },
		completed_cycle: { label: "Ukończony cykl" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Cykl o tych datach już istnieje. Aby mieć szkic, usuń daty." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Utwórz element" },
				secondary_button: { text: "Dodaj istniejący element" }
			},
			completed_no_issues: {
				title: "Brak elementów w cyklu",
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Skonfiguruj automatyzację" }
		},
		issues_empty_filter: {
			title: "Brak pasujących elementów",
			secondary_button: { text: "Wyczyść filtry" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Utwórz elementy" },
				secondary_button: { text: "Dodaj istniejący element" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Link do modułu skopiowano" },
			delete: {
	...
	command_k: { empty_state: { search: { title: "Nie znaleziono wyników" } } },
	issue_relation: { empty_state: {
		search: { title: "Brak pasujących elementów" },
		no_issues: { title: "Brak elementów" }
	} },
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Wybierz, aby zobaczyć szczegóły." },
			all: {
				title: "Brak przypisanych elementów",
	...
	active_cycle: { empty_state: {
		progress: { title: "Dodaj elementy pracy, aby śledzić postęp" },
		chart: { title: "Dodaj elementy pracy, aby wyświetlić wykres burndown." },
		priority_issue: { title: "Tutaj pojawią się elementy o wysokim priorytecie." },
		assignee: { title: "Przypisz elementy, aby zobaczyć podział przypisania." },
		label: { title: "Dodaj etykiety, aby przeprowadzić analizę według etykiet." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Zarządzaj funkcjami" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Utwórz pierwszy szkic" }
		},
		delete_modal: {
			title: "Usuń szkic",
		...
		toasts: {
			...
			deleted: { success: "Szkic usunięto" }
		}
	},
	stickies: {
		title: "Twoje notatki",
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Dodaj notatkę" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Preferencje systemowe" },
		light: { label: "Jasny" },
		dark: { label: "Ciemny" },
		light_contrast: { label: "Jasny wysoki kontrast" },
		dark_contrast: { label: "Ciemny wysoki kontrast" },
		custom: { label: "Motyw niestandardowy" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-CesXN161.js.map