//#region src/locales/pt-BR/translations.ts
var translations_default = {
	...
	auth: {
		common: {
			...
			password: {
				...
				current_password: { label: "Senha atual" },
				new_password: {
					label: "Nova senha",
		...
		sign_up: {
			...
			errors: { password: { strength: "Tente definir uma senha forte para continuar" } }
		},
		sign_in: { header: {
		...
		forgot_password: {
			...
			errors: { smtp_not_enabled: "Vemos que seu administrador não habilitou SMTP, não poderemos enviar um link de redefinição de senha" },
			toast: {
				success: {
					title: "Email enviado",
	...
	project_id_tooltip_content: "Ajuda você a identificar itens de trabalho no projeto de forma exclusiva. Máximo de 10 caracteres.",
	...
	home: {
		empty: {
			...
			widgets: {
				...
				primary_button: { text: "Gerenciar widgets" }
			}
		},
		quick_links: {
		...
		new_at_plane: { title: "Novidades no Plane" },
		quick_tutorial: { title: "Tutorial rápido" },
		widget: {
	...
	entity: {
		...
		fetch: { failed: "Erro ao buscar {entity}" },
		add: {
	...
	epic: {
		...
		create: { success: "Épico criado com sucesso" },
		add: {
	...
	issue: {
		...
		remove: {
			...
			parent: { label: "Remover item de trabalho pai" }
		},
		new: "Novo Item de trabalho",
		adding: "Adicionando item de trabalho",
		create: { success: "Item de trabalho criado com sucesso" },
		priority: {
			urgent: "Urgente",
			high: "Alta",
			medium: "Média",
		...
		comments: {
			...
			upload: { error: "Falha ao carregar o recurso. Por favor, tente novamente mais tarde." },
			copy_link: {
		...
		empty_state: { issue_detail: {
			...
			primary_button: { text: "Visualizar outros itens de trabalho" }
		} },
		sibling: { label: "Itens de trabalho irmãos" },
		archive: {
			...
			failed: { message: "Não foi possível arquivar o item de trabalho. Por favor, tente novamente." }
		},
		restore: {
			success: {
			...
			failed: { message: "Não foi possível restaurar o item de trabalho. Por favor, tente novamente." }
		},
		relation: {
	...
	view: {
		...
		create: { label: "Criar Visualização" },
		update: { label: "Atualizar Visualização" }
	},
	inbox_issue: {
		status: {
			pending: {
		...
		modal: { title: "Criar item de trabalho de admissão" },
		tabs: {
			open: "Aberto",
			closed: "Fechado"
		},
		empty_state: {
			...
			detail: { title: "Selecione um item de trabalho para visualizar seus detalhes." }
		}
	},
	workspace_creation: {
	...
	workspace_dashboard: { empty_state: { general: {
	...
	workspace_projects: {
		...
		create: { label: "Adicionar Projeto" },
		network: {
			label: "Rede",
			private: {
				title: "Privado",
		...
		common: { months_count: "{months, plural, one{# mês} other{# meses}}" },
		empty_state: {
			general: {
			...
			search: { description: "Nenhum projeto detectado com os critérios correspondentes.\nCrie um novo projeto em vez disso" }
		}
	},
	workspace_views: {
		...
		empty_state: {
			"all-issues": {
				...
				primary_button: { text: "Criar novo item de trabalho" }
			},
			assigned: {
		...
		delete_view: {
			...
			content: "Se você confirmar, todas as opções de classificação, filtro e exibição + o layout que você escolheu para esta visualização serão excluídos permanentemente sem nenhuma maneira de restaurá-los."
		}
	},
	account_settings: { profile: { change_email_modal: {
		...
		settings: {
			...
			webhooks: {
				...
				toasts: {
					...
					secret_key_copied: { message: "Chave secreta copiada para a área de transferência." },
					secret_key_not_copied: { message: "Ocorreu um erro ao copiar a chave secreta." }
				}
			},
			api_tokens: {
				title: "Tokens de API",
	...
	project_cycles: {
		...
		upcoming_cycle: { label: "Próximo ciclo" },
		completed_cycle: { label: "Ciclo concluído" },
		status: {
		...
		action: {
			...
			update: {
				...
				error: { already_exists: "Você já tem um ciclo nas datas fornecidas, se você quiser criar um ciclo de rascunho, você pode fazer isso removendo ambas as datas." }
			}
		},
		empty_state: {
			general: {
			...
			no_issues: {
				...
				primary_button: { text: "Criar novo item de trabalho" },
				secondary_button: { text: "Adicionar item de trabalho existente" }
			},
			completed_no_issues: {
	...
	project_issues: { empty_state: {
		...
		no_archived_issues: {
			...
			primary_button: { text: "Definir automação" }
		},
		issues_empty_filter: {
			title: "Nenhum item de trabalho encontrado correspondendo aos filtros aplicados",
			secondary_button: { text: "Limpar todos os filtros" }
		}
	} },
	project_module: {
		...
		empty_state: {
			...
			no_issues: {
				...
				primary_button: { text: "Criar novos itens de trabalho" },
				secondary_button: { text: "Adicionar um item de trabalho existente" }
			},
			archived: {
		...
		toast: {
			copy: { success: "Link do módulo copiado para a área de transferência" },
			delete: {
	...
	project_page: { empty_state: {
		general: {
			...
			primary_button: { text: "Crie sua primeira página" }
		},
		private: {
	...
	command_k: { empty_state: { search: { title: "Nenhum resultado encontrado" } } },
	issue_relation: { empty_state: {
		search: { title: "Nenhum item de trabalho correspondente encontrado" },
		no_issues: { title: "Nenhum item de trabalho encontrado" }
	} },
	issue_comment: { empty_state: { general: {
	...
	notification: {
		...
		empty_state: {
			detail: { title: "Selecione para ver os detalhes." },
			all: {
	...
	active_cycle: { empty_state: {
		progress: { title: "Adicione itens de trabalho ao ciclo para visualizar seu progresso" },
		chart: { title: "Adicione itens de trabalho ao ciclo para visualizar o gráfico de burndown." },
		priority_issue: { title: "Observe os itens de trabalho de alta prioridade abordados no ciclo rapidamente." },
		assignee: { title: "Adicione responsáveis aos itens de trabalho para ver uma divisão do trabalho por responsáveis." },
		label: { title: "Adicione etiquetas aos itens de trabalho para ver a divisão do trabalho por etiquetas." }
	} },
	disabled_project: { empty_state: {
		inbox: {
			...
			primary_button: { text: "Gerenciar funcionalidades" }
		},
		cycle: {
	...
	workspace_draft_issues: {
		...
		empty_state: {
			...
			primary_button: { text: "Criar seu primeiro rascunho" }
		},
		delete_modal: {
		...
		toasts: {
			...
			deleted: { success: "Rascunho excluído" }
		}
	},
	stickies: {
		...
		empty_state: {
			...
			general: {
				...
				primary_button: { text: "Adicionar anotação" }
			},
			search: {
	...
	themes: { theme_options: {
		system_preference: { label: "Preferência do sistema" },
		light: { label: "Claro" },
		dark: { label: "Escuro" },
		light_contrast: { label: "Alto contraste claro" },
		dark_contrast: { label: "Alto contraste escuro" },
		custom: { label: "Tema personalizado" }
	} },
	project_modules: {
		status: {
			backlog: "Backlog",
...
//# sourceMappingURL=translations-DW_K5yIF.js.map