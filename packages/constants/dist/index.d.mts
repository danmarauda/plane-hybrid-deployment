import * as _plane_types0 from "@plane/types";
import { ChartXAxisProperty, ChartYAxisMetric, EIssueLayoutTypes, EIssuesStoreType, EProductSubscriptionEnum, EStartOfTheWeek, EUserWorkspaceRoles, EViewAccess, IIssueDisplayProperties, IIssueFilterOptions, ILayoutDisplayFiltersOptions, IPaymentProduct, IWorkspaceSearchResults, TAllAvailableDateFilterOperatorsForDisplay, TAllAvailableOperatorsForDisplay, TAnalyticsTabsBase, TBillingFrequency, TChartColorScheme, TCoreSupportedDateFilterOperators, TCoreSupportedOperators, TEstimateSystems, TExtendedSupportedOperators, TExternalFilter, TInboxIssueStatus, TIssue, TIssueActivityComment, TIssueGroupByOptions, TIssueOrderByOptions, TIssuesListTypes, TLoginMediums, TModuleLayoutOptions, TModuleOrderByOptions, TModuleStatus, TProductBillingFrequency, TProjectAppliedDisplayFilterKeys, TProjectOrderByOptions, TStateGroups, TStaticViewTypes, TUnreadNotificationsCount, TWorkItemFilterProperty } from "@plane/types";
...
//#endregion
//#region src/analytics/common.d.ts
...
declare const LOGIN_MEDIUM_LABELS: Record<TLoginMediums, string>;
//#endregion
...
//#endregion
//#region src/event-tracker/core.d.ts
/**
 * ===========================================================================
 * Event Groups
 * ===========================================================================
...
declare const SPREADSHEET_PROPERTY_DETAILS: { [key in keyof IIssueDisplayProperties]: {
  i18n_title: string;
...
type TSupportedFilterTypeForUpdate = EIssueFilterType.DISPLAY_FILTERS | EIssueFilterType.DISPLAY_PROPERTIES | EIssueFilterType.KANBAN_FILTERS;
declare const ISSUE_DISPLAY_FILTERS_BY_LAYOUT: { [key in TIssueLayout]: Record<"filters", TIssueFilterKeys[]> };
...
declare const ISSUE_STORE_TO_FILTERS_MAP: Partial<Record<EIssuesStoreType, TFilterPropertiesByPageType>>;
declare const SUB_WORK_ITEM_AVAILABLE_FILTERS_FOR_WORK_ITEM_PAGE: (keyof IIssueFilterOptions)[];
...
declare const ACTIVITY_FILTER_TYPE_OPTIONS: Record<TActivityFilterOptionsKey, {
...
//#endregion
//#region src/issue/modal.d.ts
declare const DEFAULT_WORK_ITEM_FORM_VALUES: Partial<TIssue>;
//#endregion
//#region src/members.d.ts
type TMemberOrderByOptions = "display_name" | "-display_name" | "full_name" | "-full_name" | "email" | "-email" | "joining_date" | "-joining_date" | "role" | "-role";
interface IProjectMemberDisplayProperties {
  full_name: boolean;
...
declare const MEMBER_PROPERTY_DETAILS: { [key in keyof IProjectMemberDisplayProperties]: {
  i18n_title: string;
...
declare const MODULE_STATUS_COLORS: { [key in TModuleStatus]: string };
...
//#endregion
//#region src/rich-filters/operator-labels/core.d.ts
/**
 * Core operator labels
 */
declare const CORE_OPERATOR_LABELS_MAP: Record<TCoreSupportedOperators, string>;
/**
 * Core date-specific operator labels
 */
declare const CORE_DATE_OPERATOR_LABELS_MAP: Record<TCoreSupportedDateFilterOperators, string>;
//#endregion
//#region src/rich-filters/operator-labels/extended.d.ts
/**
 * Extended operator labels
 */
declare const EXTENDED_OPERATOR_LABELS_MAP: Record<TExtendedSupportedOperators, string>;
/**
 * Extended date-specific operator labels
 */
declare const EXTENDED_DATE_OPERATOR_LABELS_MAP: Record<TExtendedSupportedOperators, string>;
/**
 * Negated operator labels for all operators
 */
declare const NEGATED_OPERATOR_LABELS_MAP: Record<never, string>;
/**
 * Negated date operator labels for all date operators
 */
declare const NEGATED_DATE_OPERATOR_LABELS_MAP: Record<never, string>;
//#endregion
//#region src/rich-filters/operator-labels/index.d.ts
/**
 * Empty operator label for unselected state
 */
declare const EMPTY_OPERATOR_LABEL = "--";
/**
 * Complete operator labels mapping - combines core, extended, and negated labels
 */
declare const OPERATOR_LABELS_MAP: Record<TAllAvailableOperatorsForDisplay, string>;
/**
 * Complete date operator labels mapping - combines core, extended, and negated labels
 */
declare const DATE_OPERATOR_LABELS_MAP: Record<TAllAvailableDateFilterOperatorsForDisplay, string>;
//#endregion
//#region src/rich-filters/option.d.ts
/**
 * Filter config options.
 */
type TConfigOptions = Record<string, unknown>;
/**
 * Default filter config options.
 */
declare const DEFAULT_FILTER_CONFIG_OPTIONS: TConfigOptions;
/**
 * Clear filter config.
 */
type TClearFilterOptions = {
  label?: string;
 ...
 * Save view config.
 */
type TSaveViewOptions<E extends TExternalFilter> = {
  label?: string;
 ...
 * Update view config.
 */
type TUpdateViewOptions<E extends TExternalFilter> = {
  label?: string;
 ...
 */
type TExpressionOptions<E extends TExternalFilter> = {
 ...
 */
declare const DEFAULT_FILTER_EXPRESSION_OPTIONS: TExpressionOptions<TExternalFilter>;
/**
 * Auto visibility options.
 */
type TAutoVisibilityOptions = {
 ...
 */
declare const DEFAULT_FILTER_VISIBILITY_OPTIONS: TAutoVisibilityOptions;
/**
 * Filter options.
 * - expression: Filter expression options.
 * - config: Filter config options.
 */
type TFilterOptions<E extends TExternalFilter> = {
...
declare const GROUPED_WORKSPACE_SETTINGS: {
  administration: {
    ...
    i18n_label: string;
    href: string;
    access: _plane_types0.EUserWorkspaceRoles[];
...
declare const STATE_GROUPS: { [key in TStateGroups]: {
  key: TStateGroups;
  label: string;
...
//#endregion
//#region src/workspace-drafts.d.ts
