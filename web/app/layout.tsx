...
export const meta = () => [
  { title: "ALIAS | Simple, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "ALIAS | Simple, extensible, open-source project management tool." },
  {
  ...
  { property: "og:image:alt", content: "ALIAS - Modern project management" },
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="ALIAS" />
